...
function drawBlock0() {
 	if (cornerCounter == 0) {
		...
		drawLine(startX, startY, endPointA[0], endPointA[1]);
		cornerCounter++;
		...
		drawLine(startX, startY, endPointB[0], endPointB[1]);
		cornerCounter++;
		...
		drawLine(startX, startY, endPointC[0], endPointC[1]);
		cornerCounter++;
		...
		endPointD[1] = 0;
		drawLine(startX, startY, endPointD[0], endPointD[1]);
